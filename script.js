...
var task_card_string = "<div class=\"status-icon\"></div><p class=\"task-text\"><p class=\"task-status color-red\">iniciar</p><ion-icon class=\"delete fs-large mg-10\" name=\"close-circle-outline\"></ion-icon>"
var task_count = 0;
updateTaskCount();
eventSetter();
...
add_button.addEventListener('click', function(){
    ...
    task_card.setAttribute("class", "task-card iniciar");
...
function changeProgress(){
    ...
    if(status == 'iniciar'){
        ...
        statusElem.innerHTML="em progresso";
        ...
        statusElem.innerHTML="terminadas";
        statusElem.classList.remove(statusElem.classList[1]);
